...
/// 
pub fn vote<'a>(mut staking_pool: StakePool, user_account: &'a AccountInfo<'a>, user_solana_account: &'a AccountInfo<'a>, program_account: &'a AccountInfo<'a>) -> ProgramResult {            
