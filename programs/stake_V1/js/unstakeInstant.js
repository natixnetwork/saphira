...
const {getProgramAccount, getStakeAccount, getNatixTokenId, getProgramId, getTestReceiverUserTokenAccount, getPayer} = require("./constants");
(async () => {
    ...
    const instruction = new solanaWeb3.TransactionInstruction({
        ...
        programId,
        data: Buffer.from(getInstruction(3, 0)),
    });
